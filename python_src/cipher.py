...
def ShiftRows(state):
    # Shift a 16x16 matrix, with first row unchanged, second row shifted 1 to the left, third row shifted 2 to the left, and fourth row shifted 3 to the left, etc
...
shifted = ShiftRows(example_table)
for row in shifted:
    print(row)